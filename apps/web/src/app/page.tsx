...
type TerminalTab = 'curl' | 'mqtt' | 'docker';
...
export default function HomePage() {
  ...
  const [terminalTab, setTerminalTab] = useState<TerminalTab>('curl');
  ...
  const cartSavings = cart.reduce((sum, item) => sum + (item.product.originalPrice - item.product.price) * item.quantity, 0);
  ...
  // ROI Computations
  const monthlyKwhSaved = Math.round(calcHp * 0.746 * calcHours * 30 * 0.28); // 28% efficiency gain
  const monthlyElectricitySaved = Math.round(monthlyKwhSaved * 0.16); // $0.16 per kWh
  const monthlyWaterSavedLiters = Math.round(calcTanks * 1000 * 0.22 * 30); // 22% overflow prevention
          ...
          <div className="container">
            ...
            <div className="hero-button-group">
              ...
              <a href="#simulator" className="btn-secondary" style={{ padding: '12px 22px', fontSize: '15px' }}>
                <Gauge size={18} />
                Try Interactive Live Simulator
              </a>
            </div>

            {/* Trust Proof Metrics Strip */}
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '16px', background: '#FFFFFF', border: '1px solid var(--border-medium)', borderRadius: 'var(--radius-lg)', padding: '18px 24px', boxShadow: 'var(--shadow-sm)', marginBottom: '56px' }}>
            ...
            {/* Interactive "Try Before You Buy" SCADA Simulation Console */}
            <div id="simulator" className="console-wrapper">
              <div className="console-topbar">
                <div className="console-title-group">
                  ...
                  <span style={{ fontSize: '13px', fontWeight: 700, color: 'var(--text-main)', letterSpacing: '0.2px' }}>
                    INTERACTIVE HARDWARE SIMULATOR &bull; SITE #A-402 (TRY BEFORE YOU BUY)
                  </span>
                </div>
        ...
        <section id="reviews" className="reviews-section">
          <div className="container">
            <div className="section-head">
              ...
              <h2 className="section-title">Trusted by Thousands Across the Country</h2>
              <p className="section-desc">
                From luxury villas to gated residential societies and commercial fruit farms.
              </p>
            </div>
            ...
            <div className="reviews-grid-3">
              <div className="review-card">
                ...
                <p style={{ fontSize: '14px', color: 'var(--text-body)', lineHeight: 1.6 }}>
                  &ldquo;Our previous mechanical float switch jammed and our 2 HP pump dry-ran for four hours, burning the motor coils. SmartPump Pro paid for itself in two months by preventing overflows and cutting our water tanker bills completely.&rdquo;
                </p>
                <div className="review-author">
                  <div className="review-avatar">RN</div>
                  <div>
                    <div style={{ fontSize: '13.5px', fontWeight: 800, color: 'var(--text-main)' }}>Rajesh Nambiar</div>
                    <div style={{ fontSize: '11.5px', color: 'var(--text-muted)' }}>Villa Owner &bull; Verified Buyer</div>
                  </div>
                </div>
              </div>
              ...
              <div className="review-card">
                ...
                <p style={{ fontSize: '14px', color: 'var(--text-body)', lineHeight: 1.6 }}>
                  &ldquo;The ESP-NOW wireless feature was an absolute lifesaver. Our water tank is 4 floors up on the terrace and running wires down to the basement pump was quoted at $400 by electricians. SmartPump connected wirelessly in under 5 minutes.&rdquo;
                </p>
                <div className="review-author">
                  <div className="review-avatar">SM</div>
                  <div>
                    <div style={{ fontSize: '13.5px', fontWeight: 800, color: 'var(--text-main)' }}>Suresh Mehta</div>
                    <div style={{ fontSize: '11.5px', color: 'var(--text-muted)' }}>Apartment RWA President &bull; Verified Buyer</div>
                  </div>
                </div>
              </div>
              ...
              <div className="review-card">
                ...
                <p style={{ fontSize: '14px', color: 'var(--text-body)', lineHeight: 1.6 }}>
                  &ldquo;We use the Enterprise SCADA kit for our 3-phase borewell. The instantaneous dry-run cutoff protected our 5 HP submersible pump when the aquifer water table dipped during the dry season. The mobile app telemetry is world-class.&rdquo;
                </p>
                <div className="review-author">
                  <div className="review-avatar">AK</div>
                  <div>
                    <div style={{ fontSize: '13.5px', fontWeight: 800, color: 'var(--text-main)' }}>Anand Kulkarni</div>
                    <div style={{ fontSize: '11.5px', color: 'var(--text-muted)' }}>Orchard Farm Operator &bull; Verified Buyer</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="container">
            ...
            <div className="faq-list">
              {[
                ...
                {
                  q: 'Can I install SmartPump myself or do I need an electrician?',
                  a: 'SmartPump is designed for DIY plug-and-play installation in under 30 minutes with our illustrated handbook. Any local electrician can also wire the contactor relay in 15 minutes.'
                }
              ].map((faq, index) => (
        ...
        <section style={{ padding: '80px 0', background: 'linear-gradient(135deg, #0F172A 0%, #1E293B 100%)', color: '#FFFFFF', textAlign: 'center' }}>
          <div className="container" style={{ maxWidth: '780px' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'center', gap: '14px', flexWrap: 'wrap' }}>
              ...
              <a href="mailto:support@smartpump.io" className="btn-secondary" style={{ padding: '14px 24px', fontSize: '15px', background: 'transparent', color: '#FFFFFF', borderColor: '#475569' }}>
